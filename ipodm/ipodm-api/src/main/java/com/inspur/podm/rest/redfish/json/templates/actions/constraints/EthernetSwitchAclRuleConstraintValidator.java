...
import com.inspur.podm.common.types.redfish.RedfishEthernetSwitchAclRule.AclRuleCondition;
import com.inspur.podm.common.types.redfish.RedfishEthernetSwitchAclRule.AclRuleConditionId;
import com.inspur.podm.common.types.redfish.RedfishEthernetSwitchAclRule.AclRuleConditionIp;
import com.inspur.podm.common.types.redfish.RedfishEthernetSwitchAclRule.AclRuleConditionMacAddress;
import com.inspur.podm.common.types.redfish.RedfishEthernetSwitchAclRule.AclRuleConditionPort;
import com.inspur.podm.rest.redfish.json.templates.actions.AclRuleModificationJson;
import com.inspur.podm.rest.redfish.json.templates.actions.AclRuleModificationJson.AclRuleConditionImpl;
...
import static com.inspur.podm.common.types.ActionType.FORWARD;
import static com.inspur.podm.common.types.ActionType.MIRROR;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.checkNonNulls;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.getActionType;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.getForwardMirrorInterfaceContext;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.getMirrorPortRegions;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.getMirrorType;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.isNotEmptyRequest;
import static com.inspur.podm.rest.redfish.json.templates.actions.constraints.EthernetSwitchAclRuleConstraintValidatorHelper.refAssignedAndNotNull;
