...
import com.inspur.podm.common.types.ChassisType;
...
public final class ChassisDto extends RedfishDto {
    ...
    public class Oem extends RedfishOemDto {
        ...
        public class RackScaleOem {
            @JsonIgnore
            public static final String ODATA_TYPE_DEFAULT = "#inspur.Oem.Chassis";
            @JsonIgnore
            public static final String ODATA_TYPE_RACK = "#inspur.Oem.RackChassis";
    ...
    public final class Links extends RedfishLinksDto {
        ...
        public class Oem extends RedfishOemDto {
            ...
            public class RackScaleOem {
                @JsonProperty("@odata.type")
                private final String oDataType = "#inspur.Oem.ChassisLinks";
