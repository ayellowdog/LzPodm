...
public class EndpointAssemblyTask extends NodeTask {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EndpointAssemblyTask.class);
...
//    @TimeMeasured(tag = "[AssemblyTask]")
    ...
    private Endpoint createEndpoint(Fabric fabric, EndpointDto endpointDto) {
        try {
            ...
            logger.error("Endpoint creation failed for ComposedNode: {}, details: {}", nodeId, e.getMessage());
