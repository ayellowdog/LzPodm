...
public class SslConnectionManagersProvider {
	private static final Logger logger = LoggerFactory.getLogger(SslConnectionManagersProvider.class);
    ...
    public KeyManager[] getKeyManagersArray() {
        try {
            ...
            logger.error("Key managers array has not been initialized due to error {}", e.getMessage());
    ...
    public TrustManager[] getTrustManagersArray() {
        try {
            ...
            logger.error("Trust managers array has not been initialized due to error {}", e.getMessage());
    ...
    private String getPasswordForType(CertificateType certificateType) {
        try {
            ...
            logger.error("Context not found {}", e.getMessage());
