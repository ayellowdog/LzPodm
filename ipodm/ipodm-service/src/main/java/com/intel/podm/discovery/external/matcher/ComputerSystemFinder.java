...
public class ComputerSystemFinder {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ComputerSystemFinder.class);
...
//    @Transactional(REQUIRED)
    ...
    private EthernetInterface findEthernetInterface(MacAddress macAddress) {
        try {
            ...
            logger.warn("Found more than one Ethernet Interface with MAC address '{}'", macAddress);
            return null;
        }
    }
