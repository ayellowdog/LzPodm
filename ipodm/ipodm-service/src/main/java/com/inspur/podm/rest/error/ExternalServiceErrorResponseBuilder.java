...
package com.inspur.podm.rest.error;

import com.inspur.podm.business.BusinessApiException;
import com.inspur.podm.common.logger.Logger;
import com.inspur.podm.common.types.net.HttpStatusCode;
import com.inspur.podm.common.types.redfish.ExternalServiceError;
import com.inspur.podm.rest.representation.json.exceptionmappers.LogMessageBuilder;
...
import static com.inspur.podm.rest.error.ExternalServiceErrorMessageBuilder.newExternalServiceErrorMessageBuilder;
import static com.inspur.podm.rest.representation.json.exceptionmappers.LogMessageBuilder.newLogMessageBuilder;
import static com.inspur.podm.common.enterprise.utils.exceptions.RootCauseInvestigator.tryGetExternalServiceErrorInExceptionStack;
