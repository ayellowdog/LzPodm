...
import com.inspur.podm.api.business.dto.redfish.CollectionDto.Type;

import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.CHASSIS;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.COMPOSED_NODE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.DRIVE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ENDPOINT;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_INTERFACE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_SWITCH;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_SWITCH_ACLS;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_SWITCH_ACL_RULE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_SWITCH_PORT;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_SWITCH_PORT_VLAN;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ETHERNET_SWITCH_STATIC_MAC;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.EVENT_SUBSCRIPTION;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.FABRIC;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.FABRIC_SWITCH;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.FABRIC_SWITCH_PORT;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.MANAGER;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.MEMORY_MODULE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.METRIC_DEFINITION;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.METRIC_REPORT_DEFINITION;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.NETWORK_DEVICE_FUNCTION;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.NETWORK_INTERFACE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.PCIE_DEVICE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.PCIE_DEVICE_FUNCTION;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.POWER_ZONE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.PROCESSOR;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.SERVICE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.SIMPLE_STORAGE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.STORAGE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.STORAGE_POOL;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.SYSTEM;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.THERMAL_ZONE;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.VOLUME;
import static com.inspur.podm.api.business.dto.redfish.CollectionDto.Type.ZONE;
import static com.inspur.podm.service.rest.redfish.serializers.ODataForCollection.newOdataForCollectionBuilder;
